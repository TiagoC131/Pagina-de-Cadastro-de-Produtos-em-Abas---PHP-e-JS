...
<div id="menuSuperiorAdmCadastrarProduto">
		<nav class="links_menuSuperiorAdmCadastrarProduto">
				<ul>
					<li id="btn_abaCadastroNovoProduto" class="links_menuSuperiorAdmCadastrarProduto_btn_NovoProduto_Bloqueado">
							  Novo
					</li>
					<li id="btn_abaCadastroEditarProduto" class="links_menuSuperiorAdmCadastrarProduto_btn_EditarProduto_Ativo"> 
							  Editar
				    </li>
				</ul>
		</nav>
...
<div  id="div_selectCadastroDeProdutos">
	...
	<nav class="nav_menuSelecaoCadastroProdutos">
		...
		<!------- Selecionar o Código do Produto------->
		  <select name="BoxSelecionarProduto" id="BoxSelecionarProduto" class="produtoCadastrar_BoxSelecionarProduto" required>
					<option value:"0" selected disabled>Selecionar Produto</option>
		  </select>
